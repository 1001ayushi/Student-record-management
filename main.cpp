   ...
   case '2':
    {
        ...
        cout << "\n\n";
        cout<<"\t\tPROJECT DEVELOPER INFORMATION";
        cout << "\n\n";
        cout << "\t\tNAME:  AYUSHI GUPTA\n\t\tROLL NUMBER:  21052576\n\t\tCOLLEGE:  KALINGA INSTITUTE OF INDUSTRIAL TECHNOLOGY\n";
        cout << "\n\n";
    }
   }
    }while(c!='2');
...
void acceptdata()
{
    ...
    cout<<"ENTER YOUR BATCH NUMBER : KIIT/21-25/CSE-";
    cin.ignore();
    cin.get(s.id,80);
...
void viewall()
{
    ...
    while(infile.read(reinterpret_cast<char*>(&s),sizeof(student)))
    {
        ...
        cout<<"\t\t\t\tSTUDENT BATCH NUMBER : KIIT/21-25/CSE-"<<s.id<<endl<<endl;
...

{
    ...
    while(infile.read(reinterpret_cast<char*>(&s),sizeof(student)))
    {
        ...
        cout<<"\t\t\t\tSTUDENT BATCH NUMBER : KIIT/21-25/CSE-"<<s.id<<endl;
